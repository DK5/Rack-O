function [reads] = IVvoltage( volt_obj , cs_obj , VoltageList, samples)
...
fprintf(cs_obj,[':TRIGger:COUNt ',num2str(samples*length(VoltageList))]);	% Specify trigger count (1 to 2500);
